...
export default class Form extends NestedList{
	
   
	static get toolbox() {
		return {
		  title: 'Form',
		  icon: '<div class="bg-[#9bbb3f] icon-class"><img style="width: 13px;" src="https://dash.serviceform.com/images/icons/flow/text.svg" /></div>'
		};
	   }
